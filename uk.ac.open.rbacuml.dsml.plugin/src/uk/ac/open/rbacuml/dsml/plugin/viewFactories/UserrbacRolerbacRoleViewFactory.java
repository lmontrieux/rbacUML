 ...
 * @generated
 */
public class UserrbacRolerbacRoleViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacDSMLSemanticHints.SH_RBACDSMLUSERRBACROLERBACROLEEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacDSMLSemanticHints.SH_RBACDSMLUSERRBACROLERBACROLELABELEDITPART,
