...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.GrantedNodePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedNodePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedNodePropertySourceFactoryDelegate();
    }
}
