...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserInteractionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserInteractionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserInteractionPropertySourceFactoryDelegate();
    }
}
