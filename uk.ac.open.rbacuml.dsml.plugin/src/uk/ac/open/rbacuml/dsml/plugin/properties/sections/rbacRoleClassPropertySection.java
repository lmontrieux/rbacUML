...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.rbacRoleClassPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class rbacRoleClassPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new rbacRoleClassPropertySourceFactoryDelegate();
    }
}
