...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionFunctionBehaviorPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionFunctionBehaviorPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionFunctionBehaviorPropertySourceFactoryDelegate();
    }
}
