...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceExecutionEnvironmentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceExecutionEnvironmentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceExecutionEnvironmentPropertySourceFactoryDelegate();
    }
}
