 ...
 * @generated
 */
public class ScenarioresourceResourceViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacDSMLSemanticHints.SH_RBACDSMLSCENARIORESOURCERESOURCEEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacDSMLSemanticHints.SH_RBACDSMLSCENARIORESOURCERESOURCELABELEDITPART,
