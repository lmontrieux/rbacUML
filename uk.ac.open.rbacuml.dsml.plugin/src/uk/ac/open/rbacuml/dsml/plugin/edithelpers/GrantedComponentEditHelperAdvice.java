 ...
 * @generated
 */
public class GrantedComponentEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._GRANTED__COMPONENT.getStereotypeName());
