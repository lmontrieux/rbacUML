...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceStateMachinePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceStateMachinePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceStateMachinePropertySourceFactoryDelegate();
    }
}
