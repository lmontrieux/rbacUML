...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceAssociationClassPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceAssociationClassPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceAssociationClassPropertySourceFactoryDelegate();
    }
}
