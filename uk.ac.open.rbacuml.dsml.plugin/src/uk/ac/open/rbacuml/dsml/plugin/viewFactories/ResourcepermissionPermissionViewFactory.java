 ...
 * @generated
 */
public class ResourcepermissionPermissionViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacDSMLSemanticHints.SH_RBACDSMLRESOURCEPERMISSIONPERMISSIONEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacDSMLSemanticHints.SH_RBACDSMLRESOURCEPERMISSIONPERMISSIONLABELEDITPART,
