...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionDevicePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionDevicePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionDevicePropertySourceFactoryDelegate();
    }
}
