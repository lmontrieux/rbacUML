 ...
 * @generated
 */
public class ForbiddenExecutionEnvironmentEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._FORBIDDEN__EXECUTIONENVIRONMENT.getStereotypeName());
