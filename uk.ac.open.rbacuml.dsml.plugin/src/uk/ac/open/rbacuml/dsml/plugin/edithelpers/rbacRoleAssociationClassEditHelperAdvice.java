 ...
 * @generated
 */
public class rbacRoleAssociationClassEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._RBACROLE__ASSOCIATIONCLASS.getStereotypeName());
