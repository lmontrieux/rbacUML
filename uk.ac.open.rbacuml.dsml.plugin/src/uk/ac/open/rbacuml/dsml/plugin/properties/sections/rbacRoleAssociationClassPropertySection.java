...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.rbacRoleAssociationClassPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class rbacRoleAssociationClassPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new rbacRoleAssociationClassPropertySourceFactoryDelegate();
    }
}
