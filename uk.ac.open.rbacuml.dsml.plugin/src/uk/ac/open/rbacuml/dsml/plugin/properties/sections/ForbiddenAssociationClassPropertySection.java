...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ForbiddenAssociationClassPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ForbiddenAssociationClassPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ForbiddenAssociationClassPropertySourceFactoryDelegate();
    }
}
