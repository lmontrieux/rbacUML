 ...
 * @generated
 */
public class rbacRoleFunctionBehaviorEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._RBACROLE__FUNCTIONBEHAVIOR.getStereotypeName());
