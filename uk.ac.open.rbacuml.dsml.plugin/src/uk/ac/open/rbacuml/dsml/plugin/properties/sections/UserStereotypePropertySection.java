...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserStereotypePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserStereotypePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserStereotypePropertySourceFactoryDelegate();
    }
}
