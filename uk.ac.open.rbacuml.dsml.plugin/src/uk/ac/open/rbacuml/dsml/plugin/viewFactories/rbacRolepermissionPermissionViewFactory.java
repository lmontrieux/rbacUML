 ...
 * @generated
 */
public class rbacRolepermissionPermissionViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacDSMLSemanticHints.SH_RBACDSMLRBACROLEPERMISSIONPERMISSIONEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacDSMLSemanticHints.SH_RBACDSMLRBACROLEPERMISSIONPERMISSIONLABELEDITPART,
