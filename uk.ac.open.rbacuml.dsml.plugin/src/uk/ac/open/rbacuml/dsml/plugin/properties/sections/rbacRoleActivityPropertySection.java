...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.rbacRoleActivityPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class rbacRoleActivityPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new rbacRoleActivityPropertySourceFactoryDelegate();
    }
}
