...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.GrantedDevicePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedDevicePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedDevicePropertySourceFactoryDelegate();
    }
}
