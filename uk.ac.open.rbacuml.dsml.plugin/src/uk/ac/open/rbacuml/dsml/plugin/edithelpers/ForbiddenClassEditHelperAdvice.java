 ...
 * @generated
 */
public class ForbiddenClassEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._FORBIDDEN__CLASS.getStereotypeName());
