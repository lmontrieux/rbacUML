...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceFunctionBehaviorPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceFunctionBehaviorPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceFunctionBehaviorPropertySourceFactoryDelegate();
    }
}
