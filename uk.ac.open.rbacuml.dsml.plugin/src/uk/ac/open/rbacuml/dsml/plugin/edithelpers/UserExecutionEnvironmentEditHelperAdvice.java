 ...
 * @generated
 */
public class UserExecutionEnvironmentEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._USER__EXECUTIONENVIRONMENT.getStereotypeName());
