 ...
 * @generated
 */
public class ResourceStateMachineEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._RESOURCE__STATEMACHINE.getStereotypeName());
