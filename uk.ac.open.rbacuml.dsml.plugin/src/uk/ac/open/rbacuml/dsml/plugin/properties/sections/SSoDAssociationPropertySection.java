...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.SSoDAssociationPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class SSoDAssociationPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new SSoDAssociationPropertySourceFactoryDelegate();
    }
}
