...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ForbiddenClassPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ForbiddenClassPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ForbiddenClassPropertySourceFactoryDelegate();
    }
}
