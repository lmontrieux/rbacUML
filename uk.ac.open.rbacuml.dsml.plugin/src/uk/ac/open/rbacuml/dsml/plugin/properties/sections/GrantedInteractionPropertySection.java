...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.GrantedInteractionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedInteractionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedInteractionPropertySourceFactoryDelegate();
    }
}
