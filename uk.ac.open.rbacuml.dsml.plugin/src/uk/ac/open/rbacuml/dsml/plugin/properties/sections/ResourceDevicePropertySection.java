...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceDevicePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceDevicePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceDevicePropertySourceFactoryDelegate();
    }
}
