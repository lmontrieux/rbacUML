...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceInteractionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceInteractionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceInteractionPropertySourceFactoryDelegate();
    }
}
