 ...
 * @generated
 */
public class rbacRoleInteractionEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._RBACROLE__INTERACTION.getStereotypeName());
