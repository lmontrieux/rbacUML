...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.GrantedActivityPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedActivityPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedActivityPropertySourceFactoryDelegate();
    }
}
