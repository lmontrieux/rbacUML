...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.rbacRoleFunctionBehaviorPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class rbacRoleFunctionBehaviorPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new rbacRoleFunctionBehaviorPropertySourceFactoryDelegate();
    }
}
