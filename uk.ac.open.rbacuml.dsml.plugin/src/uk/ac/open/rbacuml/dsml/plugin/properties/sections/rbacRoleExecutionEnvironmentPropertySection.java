...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.rbacRoleExecutionEnvironmentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class rbacRoleExecutionEnvironmentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new rbacRoleExecutionEnvironmentPropertySourceFactoryDelegate();
    }
}
