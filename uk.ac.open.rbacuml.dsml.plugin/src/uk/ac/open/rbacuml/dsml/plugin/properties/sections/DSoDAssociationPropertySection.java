...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.DSoDAssociationPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class DSoDAssociationPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new DSoDAssociationPropertySourceFactoryDelegate();
    }
}
