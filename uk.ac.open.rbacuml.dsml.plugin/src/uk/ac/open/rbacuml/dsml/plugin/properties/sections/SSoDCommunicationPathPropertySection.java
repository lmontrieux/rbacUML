...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.SSoDCommunicationPathPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class SSoDCommunicationPathPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new SSoDCommunicationPathPropertySourceFactoryDelegate();
    }
}
