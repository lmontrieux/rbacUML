 ...
 * @generated
 */
public class SSoDCommunicationPathEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._SSOD__COMMUNICATIONPATH.getStereotypeName());
