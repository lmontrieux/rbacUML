...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ForbiddenFunctionBehaviorPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ForbiddenFunctionBehaviorPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ForbiddenFunctionBehaviorPropertySourceFactoryDelegate();
    }
}
