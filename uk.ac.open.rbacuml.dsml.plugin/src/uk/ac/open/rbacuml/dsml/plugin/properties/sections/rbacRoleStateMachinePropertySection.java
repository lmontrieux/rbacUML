...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.rbacRoleStateMachinePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class rbacRoleStateMachinePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new rbacRoleStateMachinePropertySourceFactoryDelegate();
    }
}
