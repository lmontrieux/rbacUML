...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserFunctionBehaviorPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserFunctionBehaviorPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserFunctionBehaviorPropertySourceFactoryDelegate();
    }
}
