 ...
 * @generated
 */
public class SSoDAssociationEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._SSOD__ASSOCIATION.getStereotypeName());
