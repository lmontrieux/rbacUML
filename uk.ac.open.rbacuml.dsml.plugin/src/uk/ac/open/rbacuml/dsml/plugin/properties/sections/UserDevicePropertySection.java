...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserDevicePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserDevicePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserDevicePropertySourceFactoryDelegate();
    }
}
