...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceActivityPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceActivityPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceActivityPropertySourceFactoryDelegate();
    }
}
