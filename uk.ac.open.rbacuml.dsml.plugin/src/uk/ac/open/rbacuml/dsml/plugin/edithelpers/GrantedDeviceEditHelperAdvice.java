 ...
 * @generated
 */
public class GrantedDeviceEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._GRANTED__DEVICE.getStereotypeName());
