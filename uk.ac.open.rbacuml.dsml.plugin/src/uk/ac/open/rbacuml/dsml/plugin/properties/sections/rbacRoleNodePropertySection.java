...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.rbacRoleNodePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class rbacRoleNodePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new rbacRoleNodePropertySourceFactoryDelegate();
    }
}
