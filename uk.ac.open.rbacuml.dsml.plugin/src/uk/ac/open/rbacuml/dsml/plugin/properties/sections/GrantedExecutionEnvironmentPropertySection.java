...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.GrantedExecutionEnvironmentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedExecutionEnvironmentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedExecutionEnvironmentPropertySourceFactoryDelegate();
    }
}
