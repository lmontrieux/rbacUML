...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ForbiddenInteractionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ForbiddenInteractionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ForbiddenInteractionPropertySourceFactoryDelegate();
    }
}
