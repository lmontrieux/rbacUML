...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ForbiddenProtocolStateMachinePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ForbiddenProtocolStateMachinePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ForbiddenProtocolStateMachinePropertySourceFactoryDelegate();
    }
}
