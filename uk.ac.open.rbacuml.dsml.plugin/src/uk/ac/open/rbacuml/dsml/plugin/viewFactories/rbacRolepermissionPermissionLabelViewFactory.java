 ...
 * @generated
 */
public class rbacRolepermissionPermissionLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacDSMLSemanticHints.SH_RBACDSMLRBACROLEPERMISSIONPERMISSIONTEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
