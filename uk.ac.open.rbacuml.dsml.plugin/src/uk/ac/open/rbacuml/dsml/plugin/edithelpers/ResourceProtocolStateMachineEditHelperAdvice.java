 ...
 * @generated
 */
public class ResourceProtocolStateMachineEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._RESOURCE__PROTOCOLSTATEMACHINE.getStereotypeName());
