 ...
 * @generated
 */
public class GrantedClassEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._GRANTED__CLASS.getStereotypeName());
