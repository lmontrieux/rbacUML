...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceProtocolStateMachinePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceProtocolStateMachinePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceProtocolStateMachinePropertySourceFactoryDelegate();
    }
}
