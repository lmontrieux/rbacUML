 ...
 * @generated
 */
public class rbacRoledsod1rbacRoleViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacDSMLSemanticHints.SH_RBACDSMLRBACROLEDSOD1RBACROLEEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacDSMLSemanticHints.SH_RBACDSMLRBACROLEDSOD1RBACROLELABELEDITPART,
