 ...
 * @generated
 */
public class ResourceInteractionEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._RESOURCE__INTERACTION.getStereotypeName());
