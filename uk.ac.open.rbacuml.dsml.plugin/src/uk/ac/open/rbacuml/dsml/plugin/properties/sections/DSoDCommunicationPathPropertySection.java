...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.DSoDCommunicationPathPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class DSoDCommunicationPathPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new DSoDCommunicationPathPropertySourceFactoryDelegate();
    }
}
