 ...
 * @generated
 */
public class DSoDExtensionEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._DSOD__EXTENSION.getStereotypeName());
