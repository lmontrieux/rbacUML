 ...
 * @generated
 */
public class UserComponentEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._USER__COMPONENT.getStereotypeName());
