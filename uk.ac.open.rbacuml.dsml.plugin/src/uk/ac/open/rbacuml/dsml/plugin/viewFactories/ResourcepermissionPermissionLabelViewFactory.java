 ...
 * @generated
 */
public class ResourcepermissionPermissionLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacDSMLSemanticHints.SH_RBACDSMLRESOURCEPERMISSIONPERMISSIONTEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
