...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.GrantedStereotypePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedStereotypePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedStereotypePropertySourceFactoryDelegate();
    }
}
