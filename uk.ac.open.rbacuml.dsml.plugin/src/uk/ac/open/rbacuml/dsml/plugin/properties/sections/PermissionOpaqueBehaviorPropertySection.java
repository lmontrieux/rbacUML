...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionOpaqueBehaviorPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionOpaqueBehaviorPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionOpaqueBehaviorPropertySourceFactoryDelegate();
    }
}
