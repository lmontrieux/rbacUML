 ...
 * @generated
 */
public class GrantedProtocolStateMachineEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._GRANTED__PROTOCOLSTATEMACHINE.getStereotypeName());
