...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserActivityPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserActivityPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserActivityPropertySourceFactoryDelegate();
    }
}
