...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.GrantedProtocolStateMachinePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedProtocolStateMachinePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedProtocolStateMachinePropertySourceFactoryDelegate();
    }
}
