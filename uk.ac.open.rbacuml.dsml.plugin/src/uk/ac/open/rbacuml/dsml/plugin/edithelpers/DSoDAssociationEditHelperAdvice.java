 ...
 * @generated
 */
public class DSoDAssociationEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._DSOD__ASSOCIATION.getStereotypeName());
