...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceOpaqueBehaviorPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceOpaqueBehaviorPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceOpaqueBehaviorPropertySourceFactoryDelegate();
    }
}
