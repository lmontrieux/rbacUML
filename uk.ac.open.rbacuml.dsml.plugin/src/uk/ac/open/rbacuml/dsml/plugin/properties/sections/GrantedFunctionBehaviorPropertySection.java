...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.GrantedFunctionBehaviorPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedFunctionBehaviorPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedFunctionBehaviorPropertySourceFactoryDelegate();
    }
}
