...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ForbiddenExecutionEnvironmentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ForbiddenExecutionEnvironmentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ForbiddenExecutionEnvironmentPropertySourceFactoryDelegate();
    }
}
