 ...
 * @generated
 */
public class rbacRoleOpaqueBehaviorEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._RBACROLE__OPAQUEBEHAVIOR.getStereotypeName());
