 ...
 * @generated
 */
public class ForbiddenDeviceEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._FORBIDDEN__DEVICE.getStereotypeName());
