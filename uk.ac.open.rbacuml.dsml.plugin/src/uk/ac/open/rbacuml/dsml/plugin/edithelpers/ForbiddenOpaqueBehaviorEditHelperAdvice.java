 ...
 * @generated
 */
public class ForbiddenOpaqueBehaviorEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._FORBIDDEN__OPAQUEBEHAVIOR.getStereotypeName());
