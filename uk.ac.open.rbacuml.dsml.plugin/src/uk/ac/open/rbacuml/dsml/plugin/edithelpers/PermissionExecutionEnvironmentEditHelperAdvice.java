 ...
 * @generated
 */
public class PermissionExecutionEnvironmentEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._PERMISSION__EXECUTIONENVIRONMENT.getStereotypeName());
