 ...
 * @generated
 */
public class GrantedFunctionBehaviorEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._GRANTED__FUNCTIONBEHAVIOR.getStereotypeName());
