...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ForbiddenDevicePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ForbiddenDevicePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ForbiddenDevicePropertySourceFactoryDelegate();
    }
}
