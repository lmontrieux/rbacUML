...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserAssociationClassPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserAssociationClassPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserAssociationClassPropertySourceFactoryDelegate();
    }
}
