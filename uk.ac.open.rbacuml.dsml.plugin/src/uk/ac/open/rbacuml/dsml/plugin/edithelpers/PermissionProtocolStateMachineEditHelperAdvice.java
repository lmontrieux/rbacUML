 ...
 * @generated
 */
public class PermissionProtocolStateMachineEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._PERMISSION__PROTOCOLSTATEMACHINE.getStereotypeName());
