 ...
 * @generated
 */
public class PermissionDeviceEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._PERMISSION__DEVICE.getStereotypeName());
