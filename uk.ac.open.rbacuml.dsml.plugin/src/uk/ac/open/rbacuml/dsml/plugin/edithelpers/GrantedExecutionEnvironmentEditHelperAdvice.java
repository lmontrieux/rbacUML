 ...
 * @generated
 */
public class GrantedExecutionEnvironmentEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._GRANTED__EXECUTIONENVIRONMENT.getStereotypeName());
