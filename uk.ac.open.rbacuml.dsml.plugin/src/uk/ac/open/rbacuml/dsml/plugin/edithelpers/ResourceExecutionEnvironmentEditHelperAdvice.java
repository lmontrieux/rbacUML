 ...
 * @generated
 */
public class ResourceExecutionEnvironmentEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._RESOURCE__EXECUTIONENVIRONMENT.getStereotypeName());
