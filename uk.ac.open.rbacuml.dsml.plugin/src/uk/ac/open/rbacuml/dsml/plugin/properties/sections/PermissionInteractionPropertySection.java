...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionInteractionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionInteractionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionInteractionPropertySourceFactoryDelegate();
    }
}
