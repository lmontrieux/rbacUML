...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.rbacRoleOpaqueBehaviorPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class rbacRoleOpaqueBehaviorPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new rbacRoleOpaqueBehaviorPropertySourceFactoryDelegate();
    }
}
