 ...
 * @generated
 */
public class SSoDExtensionEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._SSOD__EXTENSION.getStereotypeName());
