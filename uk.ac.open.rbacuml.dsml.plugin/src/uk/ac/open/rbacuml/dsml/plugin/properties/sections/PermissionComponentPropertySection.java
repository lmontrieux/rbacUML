...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionComponentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionComponentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionComponentPropertySourceFactoryDelegate();
    }
}
