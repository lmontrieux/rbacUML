 ...
 * @generated
 */
public class ForbiddenInteractionEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._FORBIDDEN__INTERACTION.getStereotypeName());
