...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceComponentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceComponentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceComponentPropertySourceFactoryDelegate();
    }
}
