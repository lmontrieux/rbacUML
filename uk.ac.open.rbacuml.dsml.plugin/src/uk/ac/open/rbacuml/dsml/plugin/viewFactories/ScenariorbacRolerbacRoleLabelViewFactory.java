 ...
 * @generated
 */
public class ScenariorbacRolerbacRoleLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacDSMLSemanticHints.SH_RBACDSMLSCENARIORBACROLERBACROLETEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
