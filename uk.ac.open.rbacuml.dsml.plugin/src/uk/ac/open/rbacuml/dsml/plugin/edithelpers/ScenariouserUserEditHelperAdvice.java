 ...
 * @generated
 */
public class ScenariouserUserEditHelperAdvice extends
    ...
    public ICommand getBeforeEditContextCommand(GetEditContextRequest request) {
        request.setEditContext(RbacDSMLElementTypes.SCENARIO_USER);		
    ...
    if (source != null && target != null) {
      ...
      Object value = sApp.eGet(sApp.eClass().getEStructuralFeature("user")); //$NON-NLS-1$
      if (value != null) {
        ...
        return new AbstractTransactionalCommand(request.getEditingDomain(),
            ...
            protected CommandResult doExecuteWithResult(
                ...
                sApp.eSet(sApp.eClass().getEStructuralFeature("user"), target); //$NON-NLS-1$
