...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.GrantedClassPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedClassPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedClassPropertySourceFactoryDelegate();
    }
}
