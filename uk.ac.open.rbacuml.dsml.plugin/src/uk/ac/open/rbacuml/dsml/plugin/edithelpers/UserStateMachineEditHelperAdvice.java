 ...
 * @generated
 */
public class UserStateMachineEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._USER__STATEMACHINE.getStereotypeName());
