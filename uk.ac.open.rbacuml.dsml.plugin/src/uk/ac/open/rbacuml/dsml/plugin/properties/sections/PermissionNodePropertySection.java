...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionNodePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionNodePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionNodePropertySourceFactoryDelegate();
    }
}
