 ...
 * @generated
 */
public class ForbiddenProtocolStateMachineEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._FORBIDDEN__PROTOCOLSTATEMACHINE.getStereotypeName());
