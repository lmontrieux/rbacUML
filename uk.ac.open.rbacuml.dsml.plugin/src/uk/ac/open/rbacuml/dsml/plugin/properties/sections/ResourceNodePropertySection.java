...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ResourceNodePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ResourceNodePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ResourceNodePropertySourceFactoryDelegate();
    }
}
