 ...
 * @generated
 */
public class UserProtocolStateMachineEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._USER__PROTOCOLSTATEMACHINE.getStereotypeName());
