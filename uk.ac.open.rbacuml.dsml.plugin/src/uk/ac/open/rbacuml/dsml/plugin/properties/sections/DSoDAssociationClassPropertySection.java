...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.DSoDAssociationClassPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class DSoDAssociationClassPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new DSoDAssociationClassPropertySourceFactoryDelegate();
    }
}
