 ...
 * @generated
 */
public class rbacRoleNodeEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._RBACROLE__NODE.getStereotypeName());
