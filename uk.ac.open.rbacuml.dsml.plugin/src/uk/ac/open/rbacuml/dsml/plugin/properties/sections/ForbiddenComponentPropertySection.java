...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ForbiddenComponentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ForbiddenComponentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ForbiddenComponentPropertySourceFactoryDelegate();
    }
}
