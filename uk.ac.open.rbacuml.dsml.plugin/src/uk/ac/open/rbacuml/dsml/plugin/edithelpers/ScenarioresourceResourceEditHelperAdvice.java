 ...
 * @generated
 */
public class ScenarioresourceResourceEditHelperAdvice extends
    ...
    public ICommand getBeforeEditContextCommand(GetEditContextRequest request) {
        request.setEditContext(RbacDSMLElementTypes.SCENARIO_RESOURCE);		
    ...
    if (source != null && target != null) {
      ...
      Object value = sApp.eGet(sApp.eClass().getEStructuralFeature("resource")); //$NON-NLS-1$
      if (value != null) {
        ...
        return new AbstractTransactionalCommand(request.getEditingDomain(),
            ...
            protected CommandResult doExecuteWithResult(
                ...
                ((EList)sApp.eGet(sApp.eClass().getEStructuralFeature("resource"))).add(target); //$NON-NLS-1$
