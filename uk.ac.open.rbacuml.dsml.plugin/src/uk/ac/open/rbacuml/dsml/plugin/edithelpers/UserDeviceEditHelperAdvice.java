 ...
 * @generated
 */
public class UserDeviceEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._USER__DEVICE.getStereotypeName());
