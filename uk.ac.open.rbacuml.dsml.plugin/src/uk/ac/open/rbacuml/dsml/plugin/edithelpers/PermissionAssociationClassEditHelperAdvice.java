 ...
 * @generated
 */
public class PermissionAssociationClassEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._PERMISSION__ASSOCIATIONCLASS.getStereotypeName());
