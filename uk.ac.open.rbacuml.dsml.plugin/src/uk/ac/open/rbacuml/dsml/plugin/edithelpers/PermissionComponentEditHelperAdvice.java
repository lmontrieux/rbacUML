 ...
 * @generated
 */
public class PermissionComponentEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._PERMISSION__COMPONENT.getStereotypeName());
