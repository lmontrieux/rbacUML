...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.ForbiddenActivityPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ForbiddenActivityPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ForbiddenActivityPropertySourceFactoryDelegate();
    }
}
