...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionStateMachinePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionStateMachinePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionStateMachinePropertySourceFactoryDelegate();
    }
}
