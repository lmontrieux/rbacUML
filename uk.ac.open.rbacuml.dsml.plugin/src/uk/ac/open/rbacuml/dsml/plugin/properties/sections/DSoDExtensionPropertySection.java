...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.DSoDExtensionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class DSoDExtensionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new DSoDExtensionPropertySourceFactoryDelegate();
    }
}
