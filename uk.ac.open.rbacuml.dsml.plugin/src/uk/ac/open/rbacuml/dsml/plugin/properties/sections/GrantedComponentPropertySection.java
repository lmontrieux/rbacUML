...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.GrantedComponentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedComponentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedComponentPropertySourceFactoryDelegate();
    }
}
