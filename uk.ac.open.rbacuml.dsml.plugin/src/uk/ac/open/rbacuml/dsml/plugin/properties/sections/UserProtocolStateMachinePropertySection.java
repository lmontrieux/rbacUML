...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserProtocolStateMachinePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserProtocolStateMachinePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserProtocolStateMachinePropertySourceFactoryDelegate();
    }
}
