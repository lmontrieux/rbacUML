...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserClassPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserClassPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserClassPropertySourceFactoryDelegate();
    }
}
