...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserExecutionEnvironmentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserExecutionEnvironmentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserExecutionEnvironmentPropertySourceFactoryDelegate();
    }
}
