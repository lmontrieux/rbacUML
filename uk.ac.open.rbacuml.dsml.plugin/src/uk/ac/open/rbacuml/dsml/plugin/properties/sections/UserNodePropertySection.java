...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserNodePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserNodePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserNodePropertySourceFactoryDelegate();
    }
}
