 ...
 * @generated
 */
public class UserOpaqueBehaviorEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._USER__OPAQUEBEHAVIOR.getStereotypeName());
