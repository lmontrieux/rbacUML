...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserComponentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserComponentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserComponentPropertySourceFactoryDelegate();
    }
}
