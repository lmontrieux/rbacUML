 ...
 * @generated
 */
public class ResourceActivityEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._RESOURCE__ACTIVITY.getStereotypeName());
