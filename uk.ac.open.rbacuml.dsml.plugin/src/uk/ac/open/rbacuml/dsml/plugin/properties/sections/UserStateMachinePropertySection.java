...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.UserStateMachinePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class UserStateMachinePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new UserStateMachinePropertySourceFactoryDelegate();
    }
}
