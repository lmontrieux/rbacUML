 ...
 * @generated
 */
public class rbacRoleparentrbacRoleViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacDSMLSemanticHints.SH_RBACDSMLRBACROLEPARENTRBACROLEEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacDSMLSemanticHints.SH_RBACDSMLRBACROLEPARENTRBACROLELABELEDITPART,
