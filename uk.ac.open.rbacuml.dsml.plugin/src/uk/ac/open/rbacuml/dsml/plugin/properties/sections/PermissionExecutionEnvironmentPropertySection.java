...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionExecutionEnvironmentPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionExecutionEnvironmentPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionExecutionEnvironmentPropertySourceFactoryDelegate();
    }
}
