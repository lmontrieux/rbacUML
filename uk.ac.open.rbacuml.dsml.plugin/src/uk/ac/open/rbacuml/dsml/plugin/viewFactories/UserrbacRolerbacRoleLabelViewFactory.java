 ...
 * @generated
 */
public class UserrbacRolerbacRoleLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacDSMLSemanticHints.SH_RBACDSMLUSERRBACROLERBACROLETEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
