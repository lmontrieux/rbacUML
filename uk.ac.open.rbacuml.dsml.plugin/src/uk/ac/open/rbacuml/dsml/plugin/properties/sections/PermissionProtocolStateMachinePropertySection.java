...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionProtocolStateMachinePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionProtocolStateMachinePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionProtocolStateMachinePropertySourceFactoryDelegate();
    }
}
