 ...
 * @generated
 */
public class ForbiddenStereotypeEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._FORBIDDEN__STEREOTYPE.getStereotypeName());
