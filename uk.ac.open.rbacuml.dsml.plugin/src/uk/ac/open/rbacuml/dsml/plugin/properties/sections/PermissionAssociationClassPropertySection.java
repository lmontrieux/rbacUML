...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionAssociationClassPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionAssociationClassPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionAssociationClassPropertySourceFactoryDelegate();
    }
}
