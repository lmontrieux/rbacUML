...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.rbacRoleDevicePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class rbacRoleDevicePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new rbacRoleDevicePropertySourceFactoryDelegate();
    }
}
