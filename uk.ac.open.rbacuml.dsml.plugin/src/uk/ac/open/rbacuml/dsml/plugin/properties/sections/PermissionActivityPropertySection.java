...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.PermissionActivityPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class PermissionActivityPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new PermissionActivityPropertySourceFactoryDelegate();
    }
}
