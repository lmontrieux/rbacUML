 ...
 * @generated
 */
public class GrantedActivityEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(RbacDSMLElementTypes._GRANTED__ACTIVITY.getStereotypeName());
