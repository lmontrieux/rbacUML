...
import uk.ac.open.rbacuml.dsml.plugin.properties.delegates.rbacRoleProtocolStateMachinePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class rbacRoleProtocolStateMachinePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new rbacRoleProtocolStateMachinePropertySourceFactoryDelegate();
    }
}
