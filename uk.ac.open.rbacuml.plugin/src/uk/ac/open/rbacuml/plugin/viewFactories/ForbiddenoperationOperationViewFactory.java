 ...
 * @generated
 */
public class ForbiddenoperationOperationViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacUMLSemanticHints.SH_RBACUMLFORBIDDENOPERATIONOPERATIONEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacUMLSemanticHints.SH_RBACUMLFORBIDDENOPERATIONOPERATIONLABELEDITPART,
	...
	public static IElementType getElementType() {
		return RbacUMLElementTypes.FORBIDDEN_OPERATION;
	}
