 ...
 * @generated
 */
public class ForbiddeninteractionInteractionViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacUMLSemanticHints.SH_RBACUMLFORBIDDENINTERACTIONINTERACTIONEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacUMLSemanticHints.SH_RBACUMLFORBIDDENINTERACTIONINTERACTIONLABELEDITPART,
	...
	public static IElementType getElementType() {
		return RbacUMLElementTypes.FORBIDDEN_INTERACTION;
	}
