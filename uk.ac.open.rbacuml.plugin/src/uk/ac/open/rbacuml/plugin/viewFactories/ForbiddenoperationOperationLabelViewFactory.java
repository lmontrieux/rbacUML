 ...
 * @generated
 */
public class ForbiddenoperationOperationLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacUMLSemanticHints.SH_RBACUMLFORBIDDENOPERATIONOPERATIONTEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
