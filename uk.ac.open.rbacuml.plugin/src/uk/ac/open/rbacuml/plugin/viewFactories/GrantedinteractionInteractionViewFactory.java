 ...
 * @generated
 */
public class GrantedinteractionInteractionViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacUMLSemanticHints.SH_RBACUMLGRANTEDINTERACTIONINTERACTIONEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacUMLSemanticHints.SH_RBACUMLGRANTEDINTERACTIONINTERACTIONLABELEDITPART,
	...
	public static IElementType getElementType() {
		return RbacUMLElementTypes.GRANTED_INTERACTION;
	}
