 ...
 * @generated
 */
public class RestrictedpermissionPermissionViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacUMLSemanticHints.SH_RBACUMLRESTRICTEDPERMISSIONPERMISSIONEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacUMLSemanticHints.SH_RBACUMLRESTRICTEDPERMISSIONPERMISSIONLABELEDITPART,
	...
	public static IElementType getElementType() {
		return RbacUMLElementTypes.RESTRICTED_PERMISSION;
	}
