 ...
 * @generated
 */
public class DeactivateRolesrBACRoleRBACRoleViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacUMLSemanticHints.SH_RBACUMLDEACTIVATEROLESRBACROLERBACROLEEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacUMLSemanticHints.SH_RBACUMLDEACTIVATEROLESRBACROLERBACROLELABELEDITPART,
	...
	public static IElementType getElementType() {
		return RbacUMLElementTypes.DEACTIVATEROLES_RBACROLE;
	}
