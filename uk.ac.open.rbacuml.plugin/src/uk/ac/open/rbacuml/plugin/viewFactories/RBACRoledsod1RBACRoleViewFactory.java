...
public class RBACRoledsod1RBACRoleViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacUMLSemanticHints.SH_RBACUMLRBACROLEDSOD1RBACROLEEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacUMLSemanticHints.SH_RBACUMLRBACROLEDSOD1RBACROLELABELEDITPART,
	...
	public static IElementType getElementType() {
		return RbacUMLElementTypes.RBACROLE_DSOD1;
	}
