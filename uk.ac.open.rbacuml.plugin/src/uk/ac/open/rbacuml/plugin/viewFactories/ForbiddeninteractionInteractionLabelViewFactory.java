 ...
 * @generated
 */
public class ForbiddeninteractionInteractionLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacUMLSemanticHints.SH_RBACUMLFORBIDDENINTERACTIONINTERACTIONTEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
