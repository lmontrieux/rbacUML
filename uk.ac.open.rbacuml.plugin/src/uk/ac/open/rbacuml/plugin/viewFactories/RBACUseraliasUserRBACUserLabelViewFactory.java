 ...
 * @generated
 */
public class RBACUseraliasUserRBACUserLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacUMLSemanticHints.SH_RBACUMLRBACUSERALIASUSERRBACUSERTEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
