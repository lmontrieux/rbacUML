...
public class RBACRolessod1RBACRoleViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacUMLSemanticHints.SH_RBACUMLRBACROLESSOD1RBACROLEEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacUMLSemanticHints.SH_RBACUMLRBACROLESSOD1RBACROLELABELEDITPART,
	...
	public static IElementType getElementType() {
		return RbacUMLElementTypes.RBACROLE_SSOD1;
	}
