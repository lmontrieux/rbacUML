 ...
 * @generated
 */
public class RBACUseraliasUserRBACUserViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacUMLSemanticHints.SH_RBACUMLRBACUSERALIASUSERRBACUSEREDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacUMLSemanticHints.SH_RBACUMLRBACUSERALIASUSERRBACUSERLABELEDITPART,
	...
	public static IElementType getElementType() {
		return RbacUMLElementTypes.RBACUSER_ALIASUSER;
	}
