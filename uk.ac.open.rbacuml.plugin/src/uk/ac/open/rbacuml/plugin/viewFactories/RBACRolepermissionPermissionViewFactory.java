...
public class RBACRolepermissionPermissionViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacUMLSemanticHints.SH_RBACUMLRBACROLEPERMISSIONPERMISSIONEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacUMLSemanticHints.SH_RBACUMLRBACROLEPERMISSIONPERMISSIONLABELEDITPART,
	...
	public static IElementType getElementType() {
		return RbacUMLElementTypes.RBACROLE_PERMISSION;
	}
