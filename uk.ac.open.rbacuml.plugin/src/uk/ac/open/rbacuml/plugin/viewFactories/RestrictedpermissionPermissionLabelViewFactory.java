 ...
 * @generated
 */
public class RestrictedpermissionPermissionLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacUMLSemanticHints.SH_RBACUMLRESTRICTEDPERMISSIONPERMISSIONTEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
