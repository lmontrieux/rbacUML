 ...
 * @generated
 */
public class DeactivateRolesrBACRoleRBACRoleLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacUMLSemanticHints.SH_RBACUMLDEACTIVATEROLESRBACROLERBACROLETEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
