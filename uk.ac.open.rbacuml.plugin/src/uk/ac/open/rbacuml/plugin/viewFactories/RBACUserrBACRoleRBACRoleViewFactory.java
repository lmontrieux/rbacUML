 ...
 * @generated
 */
public class RBACUserrBACRoleRBACRoleViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(RbacUMLSemanticHints.SH_RBACUMLRBACUSERRBACROLERBACROLEEDITPART);

        getViewService().createNode(semanticAdapter, view,
            RbacUMLSemanticHints.SH_RBACUMLRBACUSERRBACROLERBACROLELABELEDITPART,
	...
	public static IElementType getElementType() {
		return RbacUMLElementTypes.RBACUSER_RBACROLE;
	}
