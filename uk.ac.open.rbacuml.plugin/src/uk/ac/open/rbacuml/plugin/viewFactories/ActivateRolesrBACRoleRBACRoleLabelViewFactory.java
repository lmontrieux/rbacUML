 ...
 * @generated
 */
public class ActivateRolesrBACRoleRBACRoleLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacUMLSemanticHints.SH_RBACUMLACTIVATEROLESRBACROLERBACROLETEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
