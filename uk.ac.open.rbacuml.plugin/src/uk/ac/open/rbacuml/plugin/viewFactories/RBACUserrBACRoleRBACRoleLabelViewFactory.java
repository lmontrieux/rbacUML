 ...
 * @generated
 */
public class RBACUserrBACRoleRBACRoleLabelViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(semanticAdapter, view, RbacUMLSemanticHints.SH_RBACUMLRBACUSERRBACROLERBACROLETEXTEDITPART, ViewUtil.APPEND, persisted, getPreferencesHint());
