 ...
 * @generated
 */
public class RbacUMLEditPolicyProvider extends AbstractProvider
	...
	public void createEditPolicies(EditPart editPart) {
		editPart.installEditPolicy(PROFILE_ASSOCIATIONS_SEMANTIC_ROLE,
			new RbacUMLAssociationEditPolicy());
	}
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof CreateEditPoliciesOperation) {
			...
			if (ep instanceof IGraphicalEditPart) {
				...
				if (element != null) {
					for (IElementType elementType : RbacUMLElementTypes.NODE_TYPES) {
