 ...
 * @generated
 */
public class RbacUMLModelingAssistant extends ModelingAssistantProvider {
    ...
    public List<IElementType> getRelTypesOnSource(IAdaptable source) {
        ...
        if (eObject != null) {
            ...
            for (int i = 0; i < RbacUMLElementTypes.RELATIONSHIP_TYPES.length; ++i) {
                ...
                if (RbacUMLElementTypes.matchesSource(elementType, eObject)) {
    ...
    public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
        ...
        if (sourceEObject != null && targetEObject != null) {
            ...
            for (int i = 0; i < RbacUMLElementTypes.RELATIONSHIP_TYPES.length; ++i) {
                IElementType elementType = RbacUMLElementTypes.RELATIONSHIP_TYPES[i];
                if (RbacUMLElementTypes.matchesSource(elementType, sourceEObject) &&
                        RbacUMLElementTypes.matchesTarget(elementType, targetEObject)) {
                    result.add(elementType);
                }
            }
            return result;
    ...
    public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
        ...
        if (eObject != null) {
            ...
            for (int i = 0; i < RbacUMLElementTypes.RELATIONSHIP_TYPES.length; ++i) {
                IElementType elementType = RbacUMLElementTypes.RELATIONSHIP_TYPES[i];
                if (RbacUMLElementTypes.matchesTarget(elementType, eObject)) {
                    result.add(elementType);
                }
            }
            return result;
    ...
    public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
        EObject eObject = (EObject)target.getAdapter(EObject.class);
        if (eObject != null) {
            return removeAbstractTypes(RbacUMLElementTypes.getSources(relationshipType), eObject);
        }
        return Collections.emptyList();
    }
    ...
    public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
        EObject eObject = (EObject)source.getAdapter(EObject.class);
        if (eObject != null) {
            return removeAbstractTypes(RbacUMLElementTypes.getTargets(relationshipType), eObject);
        }
        return Collections.emptyList();
    }
    ...
    public EObject selectExistingElementForSource(IAdaptable target,
        ...
        EObject eObject = (EObject)target.getAdapter(EObject.class);
        if (eObject != null) {
            List<IElementType> sourceTypes = Arrays.asList(RbacUMLElementTypes.getSources(relationshipType));
    ...
    public EObject selectExistingElementForTarget(IAdaptable source,
        ...
        EObject eObject = (EObject)source.getAdapter(EObject.class);
        if (eObject != null) {
            List<IElementType> targetTypes = Arrays.asList(RbacUMLElementTypes.getTargets(relationshipType));
