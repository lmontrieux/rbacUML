 ...
 * @generated
 */
public class RbacUMLUtil {
    
    /**
     * @generated
     */
    public static final String RBACUML_TOOLING_ACTIVITY_ID = "uk.ac.open.rbacuml.plugin.uireduction.activity"; //$NON-NLS-1$
    
    /**
     * @generated
     */
    public static final String RBACUML_CORE_ACTIVITY_ID = "uk.ac.open.rbacuml.plugin.core.activity"; //$NON-NLS-1$
    
    /**
     * @generated
     */
    public static final String PROFILE_NAME = "rbacUML"; //$NON-NLS-1$
    
    /**
     * @generated
     */
    public static final URI PROFILE_URI = URI.createURI("pathmap://RBACUML/rbacUML.epx"); //$NON-NLS-1$
    ...
    public static ImageDescriptor getImageDescriptor(String imageFilePath) {
        ...
        URL result = uk.ac.open.rbacuml.plugin.Activator.getDefault().getBundle().getEntry(imageFilePath);
        ...
        return new ImageDescriptor() {
            public ImageData getImageData() {
            	try {
            		...
            		uk.ac.open.rbacuml.plugin.Activator.getDefault().getLog().log(new Status(IStatus.ERROR, uk.ac.open.rbacuml.plugin.Activator.PLUGIN_ID, -1, e.getLocalizedMessage(), e)); 
            	}
