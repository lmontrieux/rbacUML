 ...
 * @generated
 */
public class DeactivateRolesrBACRoleRBACRoleEditHelperAdvice extends
    ...
    public ICommand getBeforeEditContextCommand(GetEditContextRequest request) {
        request.setEditContext(RbacUMLElementTypes.DEACTIVATEROLES_RBACROLE);		
    ...
    protected ICommand getBeforeCreateRelationshipCommand(
		...
		if (source != null && target != null) {
			...
			Object value = sApp.eGet(sApp.eClass().getEStructuralFeature("rBACRole")); //$NON-NLS-1$
			if (value != null) {
        ...
        return new AbstractTransactionalCommand(request.getEditingDomain(),
            ...
            protected CommandResult doExecuteWithResult(
                ...
                ((EList)sApp.eGet(sApp.eClass().getEStructuralFeature("rBACRole"))).add(target); //$NON-NLS-1$
