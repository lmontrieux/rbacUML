 ...
 * @generated
 */
public class RBACRoledsod1RBACRoleEditHelperAdvice extends
    ...
    public ICommand getBeforeEditContextCommand(GetEditContextRequest request) {
        request.setEditContext(RbacUMLElementTypes.RBACROLE_DSOD1);		
    ...
    protected ICommand getBeforeCreateRelationshipCommand(
		...
		if (source != null && target != null) {
			...
			Object value = sApp.eGet(sApp.eClass().getEStructuralFeature("dsod1")); //$NON-NLS-1$
			if (value != null) {
        ...
        return new AbstractTransactionalCommand(request.getEditingDomain(),
            ...
            protected CommandResult doExecuteWithResult(
                ...
                ((EList)sApp.eGet(sApp.eClass().getEStructuralFeature("dsod1"))).add(target); //$NON-NLS-1$
