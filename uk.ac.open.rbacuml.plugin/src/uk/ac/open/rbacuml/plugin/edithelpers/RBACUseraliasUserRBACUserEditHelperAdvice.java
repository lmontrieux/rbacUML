 ...
 * @generated
 */
public class RBACUseraliasUserRBACUserEditHelperAdvice extends
    ...
    public ICommand getBeforeEditContextCommand(GetEditContextRequest request) {
        request.setEditContext(RbacUMLElementTypes.RBACUSER_ALIASUSER);		
    ...
    protected ICommand getBeforeCreateRelationshipCommand(
		...
		if (source != null && target != null) {
			...
			Object value = sApp.eGet(sApp.eClass().getEStructuralFeature("aliasUser")); //$NON-NLS-1$
			if (value != null) {
        ...
        return new AbstractTransactionalCommand(request.getEditingDomain(),
            ...
            protected CommandResult doExecuteWithResult(
                ...
                sApp.eSet(sApp.eClass().getEStructuralFeature("aliasUser"), target); //$NON-NLS-1$
