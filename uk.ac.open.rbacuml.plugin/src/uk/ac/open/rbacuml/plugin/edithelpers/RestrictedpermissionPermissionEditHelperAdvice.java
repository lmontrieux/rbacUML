 ...
 * @generated
 */
public class RestrictedpermissionPermissionEditHelperAdvice extends
    ...
    public ICommand getBeforeEditContextCommand(GetEditContextRequest request) {
        request.setEditContext(RbacUMLElementTypes.RESTRICTED_PERMISSION);		
    ...
    protected ICommand getBeforeCreateRelationshipCommand(
		...
		if (source != null && target != null) {
            ...
            if (target instanceof Element) {
                IElementType targetType =(IElementType)RbacUMLElementTypes
			...
			Object value = sApp.eGet(sApp.eClass().getEStructuralFeature("permission")); //$NON-NLS-1$
			if (value != null) {
        ...
        return new AbstractTransactionalCommand(request.getEditingDomain(),
            ...
            protected CommandResult doExecuteWithResult(
                ...
                ((EList)sApp.eGet(sApp.eClass().getEStructuralFeature("permission"))).add(target); //$NON-NLS-1$
