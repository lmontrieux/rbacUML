 ...
 * @generated
 */
public class ForbiddenoperationOperationEditHelperAdvice extends
    ...
    public ICommand getBeforeEditContextCommand(GetEditContextRequest request) {
        request.setEditContext(RbacUMLElementTypes.FORBIDDEN_OPERATION);		
    ...
    protected ICommand getBeforeCreateRelationshipCommand(
		...
		if (source != null && target != null) {
			...
			Object value = sApp.eGet(sApp.eClass().getEStructuralFeature("operation")); //$NON-NLS-1$
			if (value != null) {
        ...
        return new AbstractTransactionalCommand(request.getEditingDomain(),
            ...
            protected CommandResult doExecuteWithResult(
                ...
                ((EList)sApp.eGet(sApp.eClass().getEStructuralFeature("operation"))).add(target); //$NON-NLS-1$
