...
import uk.ac.open.rbacuml.plugin.properties.delegates.ActivateRolesCallOperationActionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ActivateRolesCallOperationActionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ActivateRolesCallOperationActionPropertySourceFactoryDelegate();
    }
}
