...
import uk.ac.open.rbacuml.plugin.properties.delegates.RBACUserActivityPartitionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class RBACUserActivityPartitionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new RBACUserActivityPartitionPropertySourceFactoryDelegate();
    }
}
