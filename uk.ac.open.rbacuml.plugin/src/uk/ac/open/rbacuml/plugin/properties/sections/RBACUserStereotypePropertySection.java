...
import uk.ac.open.rbacuml.plugin.properties.delegates.RBACUserStereotypePropertySourceFactoryDelegate;

/**
 * @generated
 */
public class RBACUserStereotypePropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new RBACUserStereotypePropertySourceFactoryDelegate();
    }
}
