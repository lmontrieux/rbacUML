...
import uk.ac.open.rbacuml.plugin.properties.delegates.DeactivateRolesCallOperationActionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class DeactivateRolesCallOperationActionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new DeactivateRolesCallOperationActionPropertySourceFactoryDelegate();
    }
}
