...
import uk.ac.open.rbacuml.plugin.properties.delegates.GrantedCallOperationActionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedCallOperationActionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedCallOperationActionPropertySourceFactoryDelegate();
    }
}
