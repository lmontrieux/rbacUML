...
import uk.ac.open.rbacuml.plugin.properties.delegates.ForbiddenCallBehaviorActionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class ForbiddenCallBehaviorActionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new ForbiddenCallBehaviorActionPropertySourceFactoryDelegate();
    }
}
