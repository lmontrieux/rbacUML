...
import uk.ac.open.rbacuml.plugin.properties.delegates.GrantedOpaqueActionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class GrantedOpaqueActionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new GrantedOpaqueActionPropertySourceFactoryDelegate();
    }
}
