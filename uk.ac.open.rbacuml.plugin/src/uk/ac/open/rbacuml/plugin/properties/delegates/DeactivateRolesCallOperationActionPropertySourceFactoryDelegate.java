package uk.ac.open.rbacuml.plugin.properties.delegates;
 ...
 * @generated
 */
public class DeactivateRolesCallOperationActionPropertySourceFactoryDelegate
    ...
    public boolean filterStereotype(Stereotype stereotype) {    
        return !"rbacUML::DeactivateRoles".equals(stereotype.getQualifiedName()); //$NON-NLS-1$
    }
