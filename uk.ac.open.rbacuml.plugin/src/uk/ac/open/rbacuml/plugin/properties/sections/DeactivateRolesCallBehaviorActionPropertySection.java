...
import uk.ac.open.rbacuml.plugin.properties.delegates.DeactivateRolesCallBehaviorActionPropertySourceFactoryDelegate;

/**
 * @generated
 */
public class DeactivateRolesCallBehaviorActionPropertySection
    ...
    protected IStereotypePropertySourceDelegate getStereotypePropertySourceDelegate() {
        return new DeactivateRolesCallBehaviorActionPropertySourceFactoryDelegate();
    }
}
